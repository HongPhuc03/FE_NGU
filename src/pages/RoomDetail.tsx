                    ...
                    <div className="position-relative" style={{ maxWidth: '1000px', margin: '0 auto', padding: '20px' }}>
                        ...
                        <div className="row g-3">
                            ...
                            <div className="col-md-4">
                                ...
                                {/* Liên hệ */}
                                <div className="bg-white rounded-3 p-3" style={{ boxShadow: '0 2px 8px rgba(0,0,0,0.1)', height: '210px' }}>
                                    ...
                                    <div className="d-grid gap-2">
                                        ...
                                        <button onClick={handleRentClick} className="btn btn-primary py-2 fw-bold" style={{ fontSize: '14px', marginBottom: "10px" }}>
                                            THUÊ NGAY
                                        </button>
                                    </div>
                                </div>
